...
# Common technical skills across domains
SKILL_KEYWORDS = {
...
class ResumeScorer:
    ...
    def extract_features(self, text: str) -> Dict:
        ...
        # Quantifiable metrics (numbers with context)
    ...
    def score(self, text: str) -> float:
        ...
        # Quantifiable metrics (max 10 pts)
        ...
        # Formatting (bullet points, max 5 pts)
        score += min(features["bullet_points"] * 0.5, 5)

        # Key sections bonus (max 10 pts)
